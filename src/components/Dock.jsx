  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className="mx-2 flex max-w-full items-center">
      <motion.div
        ...
        className={`${className} absolute bottom-2 sm:bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-2 sm:gap-4 rounded-xl sm:rounded-2xl border-neutral-700 border-2 pb-1 sm:pb-2 px-2 sm:px-4`}
